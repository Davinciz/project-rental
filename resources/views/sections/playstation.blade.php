...
<div class="px-6 md:px-24">
    <h2 class="text-2xl font-bold mt-16">Playstation</h2>
    <p class="text-gray-600 mb-10">Pilih console yang kamu suka <br> dan cobalah berbagai game <br> dengan genre yang beragam.</p>
</div>
