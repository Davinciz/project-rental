...
@section('content')
    <main class="relative">
        <img src="{{ asset('image/landing 1.png') }}" class="w-full h-auto object-cover" alt="Landing Image">
        <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div class="text-white text-center p-6">
                ...
                <a href="{{ route('rental.index') }}" class="bg-[#605DEC] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
